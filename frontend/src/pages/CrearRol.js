                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    checked={this.state.crear_mineral}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    name="crear_compania"
                                    onChange={this.handleBool}
                                    checked={this.state.crear_compania}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    name="crear_empleado"
                                    onChange={this.handleBool}
                                    checked={this.state.crear_empleado}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    name="crear_pedido"
                                    onChange={this.handleBool}
                                    checked={this.state.crear_pedido}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    name="crear_cliente"
                                    onChange={this.handleBool}
                                    checked={this.state.crear_cliente}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    name="crear_proyecto"
                                    onChange={this.handleBool}
                                    checked={this.state.crear_proyecto}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.crear_yacimiento}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.crear_solicitud}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.consultar_mineral}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.consultar_compania}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.consultar_empleado}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.consultar_pedido}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.consultar_cliente}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.consultar_proyecto}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.consultar_yacimiento}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.consultar_solicitud}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.modificar_mineral}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.modificar_compania}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.modificar_empleado}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.modificar_pedido}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.modificar_cliente}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.modificar_proyecto}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.modificar_yacimiento}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.modificar_solicitud}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.eliminar_mineral}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.eliminar_compania}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.eliminar_empleado}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.eliminar_pedido}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.eliminar_cliente}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.eliminar_proyecto}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.eliminar_yacimiento}
                                />
                                <i></i>
                            </label>
                        </form>
                        ...
                        <form action="">
                            <label className="form-switch">
                                <input
                                    ...
                                    onChange={this.handleBool}
                                    checked={this.state.eliminar_solicitud}
                                />
                                <i></i>
                            </label>
                        </form>
